...
public extension Color {
    static func egger(_ token: EggerColorToken, scheme: ColorScheme) -> Color {
        ...
        case .textDisabled: return Color(hex: "#5B6270")
        ...
        case .textDisabled: return Color(hex: "#9CA3AF")
        case .accent: return Color(hex: "#0A6CFF")
        case .accentPressed: return Color(hex: "#0854CC")
        case .success: return Color(hex: "#0F8A3F")
        case .warning: return Color(hex: "#B5750B")
